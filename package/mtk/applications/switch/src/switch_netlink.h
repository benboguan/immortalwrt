...
static void mt753x_netlink_free(void) { }
static void mt753x_list_swdev(struct mt753x_attr *arg, int cmd) { }
static int reg_read_netlink(struct mt753x_attr *arg, int offset, int *value) { return -1; }
static int reg_write_netlink(struct mt753x_attr *arg, int offset, int value) { return -1; }
static int phy_cl22_read_netlink(struct mt753x_attr *arg, int port_num, int phy_addr, int *value) { return -1; }
static int phy_cl22_write_netlink(struct mt753x_attr *arg, int port_num, int phy_addr, int value) { return -1; }
static int phy_cl45_read_netlink(struct mt753x_attr *arg, int port_num, int phy_dev,
			 int phy_addr, int *value) { return -1; }
static int phy_cl45_write_netlink(struct mt753x_attr *arg, int port_num, int phy_dev,
			  int phy_addr, int value) { return -1; }
static int phy_dump_netlink(struct mt753x_attr *arg, int phy_addr) { return -1; }
#endif
