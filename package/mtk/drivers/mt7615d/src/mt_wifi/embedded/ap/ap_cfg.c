...
COUNTRY_CODE_TO_COUNTRY_REGION allCountry[] = {
	...
	{156,	"CN",	"CHINA",				TRUE,	A_BAND_REGION_1,	TRUE,	G_BAND_REGION_1},//A_BAND_REGION_4=>A_BAND_REGION_1
	...
	IN INT cmd)
{
	...
	case OID_802_11_SECURITY_TYPE: {
		...
		} else if(pObj->ioctl_if_type == INT_MAIN || pObj->ioctl_if_type == INT_MBSSID || pObj->ioctl_if_type == INT_WDS) {
		pMbss = &pAd->ApCfg.MBSSID[pObj->ioctl_if];
