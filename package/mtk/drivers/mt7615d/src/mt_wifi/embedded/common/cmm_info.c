...
#define	LINE_LEN	(4+33+20+23+8+9+7+7+3)	/* Channel+SSID+Bssid+Security+RSSI+Signal+WiressMode+ExtCh+NetworkType*/
...
//			"No", "Ch", "SSID", "BSSID", "Security", "Siganl(%)", "W-Mode", " ExtCH", " NT", " SSID_Len");
	sprintf(msg + strlen(msg), "%-4s%-4s%-33s%-20s%-23s%-8s%-9s%-7s%-7s%-3s%-8s\n",
