...
/*Local definition*/
#define FIRST_AP_2G_PROFILE_PATH	"/etc/wireless/mediatek/mt7615.1.2G.dat"
#define FIRST_AP_5G_PROFILE_PATH	"/etc/wireless/mediatek/mt7615.1.5G.dat"
#define FIRST_AP_MERGE_PROFILE_PATH "/etc/wireless/mediatek/mt7615_dbdc.dat"
	...
	CHAR *final)
{
	...
	multi_profile_merge_separate("BcnReq", buf1, buf2, final);
	return NDIS_STATUS_SUCCESS;
}
#endif
